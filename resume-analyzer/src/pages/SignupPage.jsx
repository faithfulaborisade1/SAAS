              ...
              <div>
                ...
                >
                  <svg className="h-5 w-5 text-red-600" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <path d="M12.0004 24.0001C15.2404 24.0001 17.9654 22.935 19.9454 21.095L16.0804 18.095C15.0054 18.825 13.6204 19.255 12.0004 19.255C8.8704 19.255 6.2154 17.145 5.2704 14.295L1.2804 17.385C3.2554 21.31 7.3104 24.0001 12.0004 24.0001Z" fill="#34A853"/>
                  </svg>
